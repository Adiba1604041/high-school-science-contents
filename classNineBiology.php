...
<body>
  ...
  <h1>Class Nine Biology!</h1>
  <p>Welcome to the biology world of class nine</p>
</div>
  ...
  <div class="menu">
    <h2>Tutorials</h2><br>
    <?php
 $q= "Select * from upload_table where section='ClassNineBiology'";
...
<div class="main">
  ...
  <?php
  include 'connection.php';
  $posts_query="select * from blogpost where section='ClassNineBiology'";
