...
<body>
  ...
  <h1>Class Nine Higher Math!</h1>
  <p>Welcome to the higher math world of class nine</p>
</div>
  ...
  <div class="menu">
    <h2>Tutorials</h2><br>
    <?php
 $q= "Select * from upload_table where section='ClassNineHM'";
...
<div class="main">
  ...
  <?php
  include 'connection.php';
  $posts_query="select * from blogpost where section='ClassNineHM'";
