...
<body>
  ...
  <h1>Class Class Nine Physics!</h1>
  <p>Welcome to the physics world of class nine</p>
</div>
  ...
  <div class="menu">
    <h2>Tutorials</h2><br>
    <?php
 $q= "Select * from upload_table where section='ClassNinePhysics'";
...
<div class="main">
  ...
  <?php
  include 'connection.php';
  $posts_query="select * from blogpost where section='ClassNinePhysics'";
