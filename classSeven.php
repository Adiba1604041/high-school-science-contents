...
<body>
  ...
  <h1>Class Seven Science!</h1>
  <p>Welcome to the science world of class seven</p>
</div>
  ...
  <div class="menu">
    <h2>Tutorials</h2><br>
    <?php
 $q= "Select * from upload_table where section='ClassSevenScience'";
...
<div class="main">
  ...
  <?php
  include 'connection.php';
  $posts_query="select * from blogpost where section='ClassSevenScience'";
